...
INSERT INTO `location` (`id`, `lat`, `lng`, `name`, `createdAt`, `updatedAt`) VALUES
...
INSERT INTO `user` (`id`, `name`, `lastName`, `firstName`, `email`, `password`, `createdAt`, `updatedAt`) VALUES
...
INSERT INTO `rating` (`id`, `text`, `stars`, `userId`, `locationId`, `createdAt`, `updatedAt`) VALUES
